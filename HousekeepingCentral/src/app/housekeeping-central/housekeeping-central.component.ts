...
@Component({
	selector: 'app-housekeeping-central',
	templateUrl: './housekeeping-central.component.html',
	styleUrls: ['./housekeeping-central.component.sass'],
})
export class HousekeepingCentralComponent implements OnInit {
	constructor() {}
	ngOnInit(): void {}
	...
	sortRooms() {
		...
		this.averageKings[0] = Math.floor(
			this.totalKings / this.numberOfBoards
		);
		...
		this.averageQueens[0] = Math.floor(
			this.totalQueens / this.numberOfBoards
		);
